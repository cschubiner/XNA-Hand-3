...
namespace StarterGame
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                AAgameplayScreen.Random.Next(minNumParticles, maxNumParticles);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // initializeConstants
            Game1.spriteBatch.Begin(SpriteSortMode.Immediate, spriteBlendMode);
            ...
            foreach (Particle p in particles)
            {
                ...
                Game1.spriteBatch.Draw(texture, p.Position, null, color,
