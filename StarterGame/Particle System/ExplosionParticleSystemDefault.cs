...
namespace StarterGame
{
    ...
    /// best effect.
    /// </summary>
    public class ExplosionParticleSystemDefault : ParticleSystem
    {

        public ExplosionParticleSystemDefault(Game1 game, int howManyEffects)
        ...
        {
            textureFilename = "Random\\explosion";
