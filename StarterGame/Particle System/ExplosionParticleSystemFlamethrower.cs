...
namespace StarterGame
{
    ...
    /// best effect.
    /// </summary>
    public class ExplosionParticleSystemFlamethrower : ParticleSystem
    {

        public ExplosionParticleSystemFlamethrower(Game1 game, int howManyEffects)
        ...
        protected override void InitializeConstants()
        {
            ...
            minNumParticles = (int)(40*.6);
            maxNumParticles = (int)(55 * .6);
