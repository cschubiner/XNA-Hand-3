...
namespace StarterGame
{
    ...
    /// </summary>
    public class ExplosionSmokeParticleSystemDefault : ParticleSystem
    {
        public ExplosionSmokeParticleSystemDefault(Game1 game, int howManyEffects)
