...
namespace StarterGame
{
    ...
    class LobbyScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            isReadyTexture = content.Load<Texture2D>("Random\\chat_ready");
            hasVoiceTexture = content.Load<Texture2D>("Random\\chat_able");
            isTalkingTexture = content.Load<Texture2D>("Random\\chat_talking");
            voiceMutedTexture = content.Load<Texture2D>("Random\\chat_mute");
        }
