    ...
    class Screenshots : GameScreen
    {
     ...
     //       graphics = new GraphicsDeviceManager(this);
        ...
        public override void LoadContent()
        {
            ...
            images[0] = Content.Load<Texture2D>("Screenshots\\screenshot (1)");
            images[1] = Content.Load<Texture2D>("Screenshots\\screenshot (2)");
           // images[2] = Content.Load<Texture2D>("Screenshots\\screenshot (3)");
