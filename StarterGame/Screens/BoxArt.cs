...
namespace StarterGame
{
    ...
    class BoxArt : GameScreen
    {
        //#region Fields
        ContentManager Content;

        Texture2D boxartbackground;
        bool displayingwithbackground=false;
        Texture2D[] images;
        Texture2D boxartheader;
     ...
     //       graphics = new GraphicsDeviceManager(this);
        ...
        public override void LoadContent()
        {
            ...
            boxartheader = Content.Load<Texture2D>("Random\\boxartheader");
            boxartbackground = Content.Load<Texture2D>("Random\\boxart background");

            images = new Texture2D[2];

            images[0] = Content.Load<Texture2D>("Box Art\\boxArt (1)");
            images[1] = Content.Load<Texture2D>("Box Art\\boxArt (2)");
      ...
      //  Vector2 spritePosition = Vector2.Zero;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Game1.spriteBatch = ScreenManager.SpriteBatch;
              ...
              try
              {
                  if (displayingwithbackground == false)
                  ...
                  {
                      Game1.spriteBatch.Draw(boxartbackground, Vector2.Zero, Color.White);
                      Game1.spriteBatch.Draw(boxartheader, new Rectangle(94, 246, 237, 42), Color.White);
                      Game1.spriteBatch.Draw(images[imageToDisplay], new Rectangle(94, 286, 237, 285), Color.White);
                  }
              }
              catch { }
